...
public class BlogAccountConfigDialogPreference extends DialogPreference implements OnKeyListener {
	...
	public BlogAccountConfigDialogPreference(Context context, AttributeSet attrs) {
	...
	public BlogAccountConfigDialogPreference(Context context) {
        this(context, null);
    }
